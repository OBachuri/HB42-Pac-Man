...
gantt
    ...
    3D view? (#2)                                        :done, i2, 2026-07-07, 1d
    ...
    Sound epic (#9)                                      :done, i9, 2026-06-12, 2026-07-06
    ...
    Teleport (#15)                                       :done, i15, 2026-07-07, 1d
    Fly mode (#16)                                       :done, i16, 2026-07-07, 1d
    ...
    Script for Windows/mac run (#19)                     :done, i19, 2026-07-07, 1d
    README file (#20)                                    :done, i20, 2026-07-01, 2026-07-06
    Running in browser (#22)                             :done, i22, 2026-06-12, 2026-06-18
    Sound for eating gum (#23)                           :done, i23, 2026-06-09, 2026-06-10
    Sound for eating powergum (#24)                      :done, i24, 2026-07-07, 1d
    Sound for Pac-Man death (#25)                        :done, i25, 2026-06-25, 2026-06-26
    Sound for ghost death (#26)                          :done, i26, 2026-07-07, 1d
    BGM normal mode (#27)                                :done, i27, 2026-07-07, 1d
    BGM frightened mode (#28)                            :done, i28, 2026-07-07, 1d
    BGM menu + button press (#29)                        :done, i29, 2026-07-07, 1d
    ...
    Fix make lint-strict errors (#62)                    :done, i62, 2026-07-03, 2026-07-06
```